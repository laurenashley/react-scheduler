...
describe("Application", () => {
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    // 6. Confirm error message text is present in the element
    await waitForElement(() => queryByText(appointment, "Error deleting this appointment"))
          .then(() => {
            expect(getByText(appointment, "Error deleting this appointment")).toBeInTheDocument();
          });
  });
});
